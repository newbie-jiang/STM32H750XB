...
#define ATK_MS7620_IIC_SCL_GPIO_CLK_ENABLE()    do{ __HAL_RCC_GPIOB_CLK_ENABLE(); }while(0)
#define ATK_MS7620_IIC_SDA_GPIO_PORT            GPIOB
#define ATK_MS7620_IIC_SDA_GPIO_PIN             GPIO_PIN_11
#define ATK_MS7620_IIC_SDA_GPIO_CLK_ENABLE()    do{ __HAL_RCC_GPIOB_CLK_ENABLE(); }while(0)

/* IO操作 */
#define ATK_MS7620_IIC_SCL(x)                   do{ x ?                                                                                             \
                                                    HAL_GPIO_WritePin(ATK_MS7620_IIC_SCL_GPIO_PORT, ATK_MS7620_IIC_SCL_GPIO_PIN, GPIO_PIN_SET) :    \
                                                    HAL_GPIO_WritePin(ATK_MS7620_IIC_SCL_GPIO_PORT, ATK_MS7620_IIC_SCL_GPIO_PIN, GPIO_PIN_RESET);   \
                                                }while(0)

#define ATK_MS7620_IIC_SDA(x)                   do{ x ?                                                                                             \
                                                    HAL_GPIO_WritePin(ATK_MS7620_IIC_SDA_GPIO_PORT, ATK_MS7620_IIC_SDA_GPIO_PIN, GPIO_PIN_SET) :    \
                                                    HAL_GPIO_WritePin(ATK_MS7620_IIC_SDA_GPIO_PORT, ATK_MS7620_IIC_SDA_GPIO_PIN, GPIO_PIN_RESET);   \
                                                }while(0)

#define ATK_MS7620_IIC_READ_SDA()               HAL_GPIO_ReadPin(ATK_MS7620_IIC_SDA_GPIO_PORT, ATK_MS7620_IIC_SDA_GPIO_PIN)
