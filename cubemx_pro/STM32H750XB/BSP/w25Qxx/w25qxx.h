...
#define W25Qx_Enable() 			HAL_GPIO_WritePin(SPI1_FLASH_NSS_GPIO_Port, SPI1_FLASH_NSS_Pin, GPIO_PIN_RESET)
#define W25Qx_Disable() 		HAL_GPIO_WritePin(SPI1_FLASH_NSS_GPIO_Port, SPI1_FLASH_NSS_Pin, GPIO_PIN_SET)
