...
//-----------------MCU屏 LCD端口定义---------------- 
//LCD背光	PB5	
#define LCD_LED(n) (n?HAL_GPIO_WritePin(GPIOD,GPIO_PIN_4,GPIO_PIN_SET):HAL_GPIO_WritePin(GPIOD,GPIO_PIN_4,GPIO_PIN_RESET)) 	    
//LCD地址结构体
typedef struct
{
	vu16 LCD_REG;
...
void LCD_Draw_Circle(u16 x0,u16 y0,uint8_t r);						 			//画圆
void LCD_DrawLine(u16 x1, u16 y1, u16 x2, u16 y2);							//画线
void LCD_DrawRectangle(u16 x1, u16 y1, u16 x2, u16 y2);		   				//画矩形
void LCD_Fill(u16 sx,u16 sy,u16 ex,u16 ey,u32 color);		   				//填充单色
void LCD_Color_Fill(u16 sx,u16 sy,u16 ex,u16 ey,u16 *color);				//填充指定颜色
void LCD_ShowChar(u16 x,u16 y,uint8_t num,uint8_t size,uint8_t mode);						//显示一个字符
void LCD_ShowNum(u16 x,u16 y,u32 num,uint8_t len,uint8_t size);  						//显示一个数字
void LCD_ShowxNum(u16 x,u16 y,u32 num,uint8_t len,uint8_t size,uint8_t mode);				//显示 数字
void LCD_ShowString(u16 x,u16 y,u16 width,u16 height,uint8_t size,uint8_t *p);		//显示一个字符串,12/16字体
