...
//返回值:0,成功;1,失败。
uint8_t LTDC_Clk_Set(u32 pll3m,u32 pll3n,u32 pll3r)
{
...
//sx,sy:起始坐标
//width,height:宽度和高度
void LTDC_Layer_Window_Config(uint8_t layerx,u16 sx,u16 sy,u16 width,u16 height)
{
...
//返回值:无
void LTDC_Layer_Parameter_Config(uint8_t layerx,u32 bufaddr,uint8_t pixformat,uint8_t alpha,uint8_t alpha0,uint8_t bfac1,uint8_t bfac2,u32 bkcolor)
{
